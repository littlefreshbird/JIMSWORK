...
public class MyhistoryListAdapter extends BaseAdapter {
    ...
    public ArrayList<MyhistoryInfo> getList() {
        return list;
    }

    public void setList(ArrayList<MyhistoryInfo> list) {
        this.list = list;
    }

    private Context context;

    public MyhistoryListAdapter(Context context, ArrayList<MyhistoryInfo> list) {
        this.context = context;
        this.list = list;
    }

    private ArrayList<MyhistoryInfo> list;
